...
export function seed() {
  return {
    ...
    products: [
      { id: "p-narazuke", handle: "daiginjo-narazuke", title: "大吟醸の奈良漬", priceJpy: 3800, unit: "/ 1袋", category: "看板",  imgTone: "",       desc: "大吟醸の酒粕で漬け重ねた、里の味みかわの看板商品。ご飯のお供・贈答・お酒の肴まで、長く愛されてきた里の味の代表作です。" },
